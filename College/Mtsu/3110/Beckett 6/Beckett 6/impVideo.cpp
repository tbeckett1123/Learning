...
ofstream& operator<<(ofstream& out, const Video& printer)
{
	out	<<printer.title<<endl
		<<printer.stars<<endl
		<<printer.director<<endl
		<<printer.producer<<endl
		<<printer.production_company<<endl
		<<printer.available<<endl;
