...
namespace SymbolTable
{
    ...
    public class classSymbolTable
    {
        ...
        /*
         * This returns the current scope, which is needed to put the tokens into the symbol table.
         * 
         * Written by: Chris Eadie 
         * 
         */
        public string returnScope()
        {
            object tempScope = stackScopes.Peek();
            return tempScope.ToString();
        }
        /*
         * This creates a default scope.
         * 
         * Written by: Chris Eadie 
         * 
         */
